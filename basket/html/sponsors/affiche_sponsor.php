<h1>Page d'affichage des sponsors</h1>
<?php
    ...
    foreach ($lignes as $ligne) {
        ...
        echo "<p>",$ligne['nom']," ",$ligne['adresse']," ",$ligne['ville']," ",$ligne['codePostal']," ",$ligne['telephone']," ",$ligne['lien']," ",$ligne['description']," ","<img style="."'width: 10%'"."src='http://localhost/basket/basket/images/".$ligne['image']."'></p>";
    }
?>
